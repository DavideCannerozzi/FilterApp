...
function App() {
  ...
  useEffect(() => {
    fetch('https://jsonplaceholder.typicode.com/todos/')
      .then((res) => res.json())
      .then((json: Todo[]) => setData(json)) // specify what we get from the api call, an array [] of object
  }, [])
  ...
  return (
    <div className="App">
      <Input getValue={getValue} inputValue={inputValue} />
      {errorMessage ? <p>{errorMessage}</p> : null}
      <List inputValue={inputValue} filterData={filterData} />
    </div>
  )
}
